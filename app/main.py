    ...
    if generate_cover_letter or generate_qa:
        ...
        try:
            ...
            if generate_cover_letter:
                ...
                if "concise_text" not in st.session_state:
                    st.session_state.concise_text = concise_letter
                if "detailed_text" not in st.session_state:
                    st.session_state.detailed_text = detailed_letter
                ...
                tone = st.selectbox(
                    "Tone",
                    ["Default", "Formal", "Friendly", "Confident"],
                    key="tone_select",
                )
                ...
                if st.button("Finalize Cover Letter"):
                    ...
                    st.code(final_letter, language="markdown")
